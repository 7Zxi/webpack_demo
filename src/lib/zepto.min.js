...
export default (function (t) {
    var e = function () {
        ...
        function Y(t, i, r) {
            for (n in i) r && (R(i[n]) || M(i[n])) ? (R(i[n]) && !R(t[n]) && (t[n] = {}), M(i[n]) && !M(t[n]) && (t[n] = []), Y(t[n], i[n], r)) : i[n] !== e && (t[n] = i[n])
        }
        ...
        var e, n, i, r, C, N, o = [], a = o.concat, s = o.filter, u = o.slice, f = t.document, c = {}, l = {},
            ...
            T = /^[\w-]*$/, j = {}, S = j.toString, O = {}, P = f.createElement("div"), D = {
                tabindex: "tabIndex",
                readonly: "readOnly",
                "for": "htmlFor",
                "class": "className",
        ...
        return O.matches = function (t, e) {
            ...
            return o && (r = P).appendChild(t), i = ~O.qsa(r, e).indexOf(t), o && P.removeChild(t), i
        }, C = function (t) {
        ...
        }, O.fragment = function (t, n, r) {
            var o, a, s;
            return d.test(t) && (o = i(f.createElement(RegExp.$1))), o || (t.replace && (t = t.replace(m, "<$1></$2>")), n === e && (n = p.test(t) && RegExp.$1), n in E || (n = "*"), s = E[n], s.innerHTML = "" + t, o = i.each(u.call(s.childNodes), function () {
                s.removeChild(this)
            ...
            var r;
            if (!t) return O.Z();
            if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && p.test(t)) r = O.fragment(t, RegExp.$1, n), t = null; else {
                if (n !== e) return i(n).find(t);
                r = O.qsa(f, t)
            } else {
                if (A(t)) return i(f).ready(t);
                if (O.isZ(t)) return t;
                if (M(t)) r = z(t); else if (k(t)) r = [t], t = null; else if (p.test(t)) r = O.fragment(t.trim(), RegExp.$1, n), t = null; else {
                    if (n !== e) return i(n).find(t);
                    r = O.qsa(f, t)
                }
            }
            ...
            return !1
        }, i.type = L, i.isFunction = A, i.isWindow = $, i.isArray = M, i.isPlainObject = R, i.isEmptyObject = function (t) {
            var e;
            for (e in t) return !1;
            return !0
            ...
            concat: function () {
                ...
                return a.apply(O.isZ(this) ? this.toArray() : this, n)
            },
            map: function (t) {
            ...
            is: function (t) {
                return "string" == typeof t ? this.length > 0 && O.matches(this[0], t) : t && this.selector == t.selector
            },
            not: function (t) {
                var n = [];
            ...
            find: function (t) {
                ...
                }) : 1 == this.length ? i(O.qsa(this[0], t)) : this.map(function () {
                    return O.qsa(this, t)
                }) : i()
            },
            closest: function (t, e) {
                ...
                return this.each(function (i, o) {
                    for (; o && !(r ? r.indexOf(o) >= 0 : O.matches(o, t));) o = o !== e && !F(o) && o.parentNode;
            ...
            prop: function (t, e) {
                return t = D[t] || t, "string" != typeof t || 1 in arguments ? this.each(function (i) {
                    if (k(t)) for (n in t) this[D[n] || n] = t[n]; else this[t] = J(this, e, i, this[t])
                }) : this[0] && this[0][t]
            },
            ...
            css: function (t, e) {
                ...
                var s = "";
                if ("string" == L(t)) e || 0 === e ? s = q(t) + ":" + H(t, e) : this.each(function () {
            ...
            i.fn[n] = function () {
                var n, s, a = i.map(arguments, function (t) {
                    ...
                    return n = L(t), "array" == n ? (t.forEach(function (t) {
                        return t.nodeType !== e ? r.push(t) : i.zepto.isZ(t) ? r = r.concat(t.get()) : void (r = r.concat(O.fragment(t)))
                    }), r) : "object" == n || null == t ? t : O.fragment(t)
                }), u = this.length > 1;
        ...
        }), O.Z.prototype = U.prototype = i.fn, O.uniq = N, O.deserializeValue = K, i.zepto = O, i
    }();
    return t.Zepto = e, void 0 === t.$ && (t.$ = e), function (e) {
        ...
        e.fn.delegate = function (t, e, n) {
            ...
            return t && !a(t) ? (e.each(t, function (t, e) {
                h.on(t, n, s, e, f)
            }), h) : (a(n) || o(u) || u === !1 || (u = s, s = n, n = i), (u === i || s === !1) && (u = s, s = i), u === !1 && (u = w), h.each(function (i, o) {
                f && (c = function (t) {
                    return x(o, t.type, u), u.apply(this, arguments)
                }), n && (l = function (t) {
                    var i, a = e(t.target).closest(n, o).get(0);
                    return a && a !== o ? (i = e.extend(S(t), {
                        currentTarget: a,
                        liveFired: o
            ...
            return t && !a(t) ? (e.each(t, function (t, e) {
                s.off(t, n, e)
            }), s) : (a(n) || o(r) || r === !1 || (r = n, n = i), r === !1 && (r = w), s.each(function () {
                x(this, t, r, n)
            }))
        }, e.fn.trigger = function (t, n) {
            return t = a(t) || e.isPlainObject(t) ? e.Event(t) : j(t), t._args = n, this.each(function () {
            ...
            return this.each(function (o, s) {
                i = S(a(t) ? e.Event(t) : t), i._args = n, i.target = s, e.each(p(s, t.type || t), function (t, e) {
        ...
        function S(t) {
            t.processData && t.data && "string" != e.type(t.data) && (t.data = e.param(t.data, t.traditional)), !t.data || t.type && "GET" != t.type.toUpperCase() && "jsonp" != t.dataType || (t.url = j(t.url, t.data), t.data = void 0)
        }
        ...
        function N(t, n, i, r) {
            ...
            e.each(n, function (n, u) {
                o = e.type(u), r && (n = i ? r : r + "[" + (s || "object" == o || "array" == o ? n : "") + "]"), !r && a ? t.add(u.name, u.value) : "array" == o || !i && "object" == o ? N(t, u, i, n) : t.add(n, u)
            })
        }
        ...
        h.href = t.location.href, e.active = 0, e.ajaxJSONP = function (r, o) {
            ...
            var c, p, a = r.jsonpCallback, s = (e.isFunction(a) ? a() : a) || "Zepto" + n++,
                u = i.createElement("script"), f = t[s], l = function (t) {
            ...
            m(a), a.crossDomain || (u = i.createElement("a"), u.href = a.url, u.href = u.href, a.crossDomain = h.protocol + "//" + h.host != u.protocol + "//" + u.host), a.url || (a.url = t.location.toString()), (f = a.url.indexOf("#")) > -1 && (a.url = a.url.slice(0, f)), S(a);
            var c = a.dataType, p = /\?.+=\?/.test(a.url);
            if (p && (c = "jsonp"), a.cache !== !1 && (n && n.cache === !0 || "script" != c && "jsonp" != c) || (a.url = j(a.url, "_=" + Date.now())), "jsonp" == c) return p || (a.url = j(a.url, a.jsonp ? a.jsonp + "=?" : a.jsonp === !1 ? "" : "callback=?")), e.ajaxJSONP(a, s);
            var P, d = a.accepts[c], g = {}, b = function (t, e) {
                g[t.toLowerCase()] = [t, e]
            }, O = /^([\w-]+:)\/\//.test(a.url) ? RegExp.$1 : t.location.protocol, C = a.xhr(), N = C.setRequestHeader;
            if (s && s.promise(C), a.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", d || "*/*"), (d = a.mimeType || d) && (d.indexOf(",") > -1 && (d = d.split(",", 2)[0]), C.overrideMimeType && C.overrideMimeType(d)), (a.contentType || a.contentType !== !1 && a.data && "GET" != a.type.toUpperCase()) && b("Content-Type", a.contentType || "application/x-www-form-urlencoded"), a.headers) for (o in a.headers) b(o, a.headers[o]);
            if (C.setRequestHeader = b, C.onreadystatechange = function () {
                if (4 == C.readyState) {
                    C.onreadystatechange = E, clearTimeout(P);
                    var t, n = !1;
                    if (C.status >= 200 && C.status < 300 || 304 == C.status || 0 == C.status && "file:" == O) {
                        if (c = c || T(a.mimeType || C.getResponseHeader("content-type")), "arraybuffer" == C.responseType || "blob" == C.responseType) t = C.response; else {
                            t = C.responseText;
                            try {
                                t = w(t, c, a), "script" == c ? (1, eval)(t) : "xml" == c ? t = C.responseXML : "json" == c && (t = l.test(t) ? null : e.parseJSON(t))
                            } catch (i) {
                                n = i
                            }
                            if (n) return x(n, "parsererror", C, a, s)
                        }
                        y(t, C, a, s)
                    } else x(C.statusText || null, C.status ? "error" : "abort", C, a, s)
                }
            }, v(C, a) === !1) return C.abort(), x(null, "abort", C, a, s), C;
            var D = "async" in a ? a.async : !0;
            if (C.open(a.type, a.url, D, a.username, a.password), a.xhrFields) for (o in a.xhrFields) C[o] = a.xhrFields[o];
            for (o in g) N.apply(C, g[o]);
            return a.timeout > 0 && (P = setTimeout(function () {
                C.onreadystatechange = E, C.abort(), x(null, "timeout", C, a, s)
            }, a.timeout)), C.send(a.data ? a.data : null), C
        }, e.get = function () {
            return e.ajax(O.apply(null, arguments))
        }, e.post = function () {
            ...
            var s, r = this, o = t.split(/\s/), u = O(t, n, i), f = u.success;
        ...
        o.style.transform === e && t.each(r, function (t, r) {
            ...
            var x, w, j, b = {}, E = "", T = this, S = t.fx.transitionEnd, O = !1;
            if (i === e && (i = t.fx.speeds._default / 1e3), y === e && (y = 0), t.fx.off && (i = 0), "string" == typeof n) b[h] = n, b[p] = i + "s", b[m] = y + "s", b[d] = r || "linear", S = t.fx.animationEnd; else {
                w = [];
                for (x in n) a.test(x) ? E += x + "(" + n[x] + ") " : (b[x] = n[x], w.push(v(x)));
                E && (b[s] = E, w.push(s)), i > 0 && "object" == typeof n && (b[u] = w.join(", "), b[f] = i + "s", b[l] = y + "s", b[c] = r || "linear")
            }
            return j = function (e) {
                ...
                O = !0, t(this).css(g), o && o.call(this)
        ...
        function s(t, i, r, o, a) {
            ...
            var s = {opacity: r};
            return o && (s.scale = o, t.css(e.fx.cssPrefix + "transform-origin", "0 0")), t.animate(s, i, null, a)
        }
        ...
        var r = (t.document, e.fn.show), o = e.fn.hide, a = e.fn.toggle;
        e.fn.show = function (t, e) {
            return r.call(this), t === n ? t = 0 : this.css("opacity", 0), s(this, t, 1, "1,1", e)
        ...
        function w(w) {
            ...
            b(), h = w && "down" in w ? w : "ontouchstart" in document ? {
                ...
                (!(C = x(t, "down")) || y(t)) && (O = C ? t : t.touches[0], t.touches && 1 === t.touches.length && n.x2 && (n.x2 = void 0, n.y2 = void 0), E = Date.now(), T = E - (n.last || E), n.el = e("tagName" in O.target ? O.target : O.target.parentNode), i && clearTimeout(i), n.x1 = O.pageX, n.y1 = O.pageY, T > 0 && 250 >= T && (n.isDoubleTap = !0), n.last = E, a = setTimeout(m, s), u && C && u.addPointer(t.pointerId))
            }, l = function (t) {
                (!(C = x(t, "move")) || y(t)) && (O = C ? t : t.touches[0], g(), n.x2 = O.pageX, n.y2 = O.pageY, j += Math.abs(n.x1 - n.x2), S += Math.abs(n.y1 - n.y2))
            }, c = function (t) {
                (!(C = x(t, "up")) || y(t)) && (g(), n.x2 && Math.abs(n.x1 - n.x2) > 30 || n.y2 && Math.abs(n.y1 - n.y2) > 30 ? o = setTimeout(function () {
                    n.el && (n.el.trigger("swipe"), n.el.trigger("swipe" + d(n.x1, n.x2, n.y1, n.y2))), n = {}
                }, 0) : "last" in n && (30 > j && 30 > S ? r = setTimeout(function () {
                    var t = e.Event("tap");
